...
namespace TxtTags.Common
{
    ...
    public class AnimationHelper
    {
        ...
        {
            var animation = new DoubleAnimation(toValue, new Duration(TimeSpan.FromMilliseconds(milliseconds)))
            {
                EasingFunction = new PowerEase { EasingMode = EasingMode.EaseInOut }
            };
            return animation;
        ...
        {
            var collection = Regex.Matches(geometryStr, HandyControl.Tools.RegexPatterns.DigitsPattern);
